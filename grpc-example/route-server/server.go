...
func (s *routeGuideServer) RecordRoute(ctx context.Context, point *pb.Point) (*pb.RouteSummary, error) {
	return nil, nil
}
...
func GetRouteSvc() *routeGuideServer {
...
func main() {
	listen, err := net.Listen("tcp", "localhost:10005")
	if err != nil {
